...
public class Until {
    ...
    public static final String PIZZA_3_DESCRIPTION = "Make a veggie pizza that's healthy and low-fat instead of ordering a takeaway. This easy recipe uses goat's cheese for tang while the onions give it sweetness...";
    ...
    public static final String PIZZA_4_DESCRIPTION = "The quantities for this are generous, so if you have any leftovers, pop a wedge of cold pizza into your lunchbox the next day";
    ...
    public static final String PIZZA_5_DESCRIPTION = "Not good for you? Think again, this easy to make pizza is low fat and full of calcium";
    ...
    public static final String PIZZA_6_DESCRIPTION = "Use seeded tortillas as pizza bases for a quick and healthy lunch - crack an egg in the centre and bake to boost protein intake";
    ...
    public static final String PIZZA_7_TITLE = "Chicken tikka masala pizzas";
    public static final String PIZZA_7_DESCRIPTION = "Rustle up our spiced chicken pizzas using naan bread in just 20 minutes. To balance the heat, serve them with dollops of mango chutney and natural yogurt";
    public static final String PIZZA_7_RECIPE = "Heat oven to 180C/160C fan/gas 4. Toss the red onion with the red wine vinegar and a good pinch of salt and set aside (the vinegar will soften the onion slightly, which is a blessing as no one wants completely raw onion on pizza).\n" +
            "\n" +
    ...
    public static final String PIZZA_8_TITLE = "Ultimate pizza Margherita";
    public static final String PIZZA_8_DESCRIPTION = "Take your senses on a trip to Italy with this authentic pizza Margherita";
    public static final String PIZZA_8_RECIPE = "In a bowl, mix flour, semolina, salt and yeast. Make a dip in the middle, pour in oil, water, then stir and squeeze everything together (hands are easiest for this). The dough should feel very sticky (pic 1). When it is well mixed, cover and leave for 15 mins.\n" +
            "\n" +
    ...
    public static final String PIZZA_9_TITLE = "Pizza with homemade sauce";
    public static final String PIZZA_9_DESCRIPTION = "Make pizza for the family with a homemade base and tomato sauce. The recipe is perfect to get kids involved in cooking. Top with mozzarella and fresh basil";
    public static final String PIZZA_9_RECIPE = "Tip the flour into a bowl, then stir in the yeast and 1 tsp salt. Make a well in the centre and pour in 200ml warm water (make sure it’s not too hot) along with the oil. Stir together with a wooden spoon until you have a soft, fairly wet dough.\n" +
            "\n" +
    ...
    public static final String PIZZA_10_TITLE = "No yeast pizza dough";
    public static final String PIZZA_10_DESCRIPTION = "Try this easy no yeast recipe for pizza dough using just flour, baking powder, salt and oil. Recipe by Helen Hurrell, mum of BBC Good Food member Eleanor\n";
    public static final String PIZZA_10_RECIPE = "Heat the oven to 200C/180C fan/gas 6.\n" +
            "\n" +
